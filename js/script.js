...
const feedPosts = [
    ...
    },
    {
        ...
        text: [
            "Мы привыкли",
            "оценивать день по результатам.",
            "",
            "Сделал — хороший день.",
            "Не сделал — плохой.",
            "",
            "Но что, если спросить иначе:",
            "",
    ...
    },
    {
        ...
        text: [
            ...
            "К тому, что мог сказать.",
            "К тому, что нужно было сделать иначе.",
            "",
            "И постепенно",
            "всё внимание оказывается там —",
            "в прошлом,",
            "в разговорах,",
            "в мыслях.",
            "",
            "А жизнь продолжает происходить",
            "прямо рядом.",
            "",
            "И ты её не замечаешь.",
            "",
            "Если сегодня поймаешь себя",
            "в этом круговороте мыслей —",
    ...
    },
    {
        ...
        text: [
            "Сегодня вечером",
            "просто посиди у окна.",
            "",
            "Без цели.",
            "Без телефона.",
            "",
            "Посмотри на небо.",
            "Заметь, как меняется свет.",
            "Как всё понемногу затихает.",
            "",
            "Никуда не спеши.",
            "",
